...
dialog_I(
    ...
    pres_use_image = gtk_image_new_from_icon_name("channel-green", GTK_ICON_SIZE_MENU);
...
//                                              GTK_ICON_SIZE_MENU);
    disc_use_image = gtk_image_new_from_icon_name("channel-red", GTK_ICON_SIZE_MENU);
...
//                                                 GTK_ICON_SIZE_MENU);
    rigmask_use_image = gtk_image_new_from_icon_name("channel-blue", GTK_ICON_SIZE_MENU);
...
//            gtk_image_new_from_stock(GIMP_STOCK_RESET, GTK_ICON_SIZE_MENU);
    ...
    resetvalues_icon = gtk_image_new_from_icon_name("edit-undo", GTK_ICON_SIZE_MENU);
    ...
    v_separator = gtk_separator_new(GTK_ORIENTATION_VERTICAL);
...
//            gtk_image_new_from_stock(GIMP_STOCK_VISIBLE, GTK_ICON_SIZE_MENU);
    ...
    dump_icon = gtk_image_new_from_icon_name("view-visible", GTK_ICON_SIZE_MENU);
...
callback_alarm_triggered(GtkWidget *size_entry, gpointer data) {
    ...
    gimp_image_undo_group_start_id(c_data->image_ID);
    render_success = render_interactive(state, p_data->carver_data);
    gimp_image_undo_group_end_id(c_data->image_ID);
    if (!render_success) {
